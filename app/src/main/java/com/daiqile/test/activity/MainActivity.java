...
import com.daiqile.test.fragment.AccountFragment;
import com.daiqile.test.fragment.IndexFragment;
import com.daiqile.test.fragment.InvestFragment;
import com.daiqile.test.fragment.MoreFragment;
import com.daiqile.test.utils.ToastUtil;
import com.daiqile.test.view.TopBar;
import com.daiqile.test.view.ViewPagerFix;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onRestart() {
        ...
        int index = intetn.getIntExtra("index", -1);
        if (index != -1){
